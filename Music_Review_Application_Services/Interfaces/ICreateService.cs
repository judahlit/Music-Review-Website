...
namespace Music_Review_Application_Services.Interfaces
{
    public interface ICreateService
    {
        ...
        string CreateAlbum(string title, List<Track> tracks, List<string> artistNames, List<string> genreNames, string dateDay, string dateMonth, string dateYear, string imgPath);
